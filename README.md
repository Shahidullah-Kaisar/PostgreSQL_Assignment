...
একটা ডেটাবেজে সাধারণত তথ্যগুলো ভাগ ভাগ করে রাখা হয় আলাদা টেবিলে, যেন ডেটা বারবার না লিখতে হয় (এটাই Normalization)।
তখন দরকার পড়ে তাল মিলিয়ে একসাথে সেই ডেটাগুলো দেখার, সেই কাজটাই করে JOIN.
